...
$firstName = $_POST['firstName']; // Typo: Change 'fistName' to 'firstName'
...
$layBayDate = $_POST['layBayDate']; // Typo: Change 'laybayDate' to 'layBayDate'
$expireDates = $_POST['expireDates']; // Typo: Change 'expireDates' to 'expireDates'
